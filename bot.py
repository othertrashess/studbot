...
def start_message(message):
    ...
    text = text = '*Привет!* 👋\n\nЯ - бот Студенческого комитета МГУ. Я рад приветствовать тебя! Ниже ты найдешь доступные клавиши, которые помогут нам лучше понимать друг друга и продолжить наше общение. Выбери пункт меню, который тебе интересен, и мы сможем начать работу вместе 🔽'
