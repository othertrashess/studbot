...
def send_notification(message):
    notification_text = f"Новое сообщение в чате с ботом"
...
def start_message(message):
     bot.send_message(message.chat.id, '*Привет!* 👋\n\nЯ - бот Студенческого комитета МГУ. Я рад приветствовать тебя! Ниже ты найдешь доступные клавиши, которые помогут нам лучше понимать друг друга и продолжить наше общение. Выбери пункт меню, который тебе интересен, и мы сможем начать работу вместе. ❤️', reply_markup=markup)
